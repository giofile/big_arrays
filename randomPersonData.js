...
// landenlijst
const countries = randomPersonData.region
console.log(countries);
// const allCountries = ( ()=>{})


const btnCountries = document.querySelector('.country')

btnCountries.addEventListener('click', countries)



// steenbokvrouwen

const vrouw (randomPersonData) = randomPersonData.map((item)=> item.gender === "female")  
const steenbok(vrouw) = vrouw.map((item)=>{ item.birthday.dmy ==="22/12"})

console.log(vrouw);

console.log(steenbok);

const btnSteenbok = document.querySelector('.steen')
btnSteenbok.addEventListener('click', )


//ouwe creditcards

const age = randomPersonData.age >18
console.log(age);
const credit = randomPersonData.credit_card.expiration > "12/21"
console.log(credit);

const btnCreditCard = document.querySelector('.creditcards')
btnCreditCard.addEventListener('click', )


// meeste mensen

const toutesCountries = randomPersonData.region
console.log(toutesCountries);
